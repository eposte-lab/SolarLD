...
_PROV: dict[str, dict[str, Any]] = {
    "AG": {
        ...
        "lng": 13.58,
        "cap_pfx": "92",
        "cities": ["Agrigento", "Sciacca", "Canicattì"],
    },
    "AL": {
        "lat": 44.91,
        "lng": 8.62,
        "cap_pfx": "15",
        "cities": ["Alessandria", "Tortona", "Novi Ligure"],
    },
    ...
    "AQ": {
        ...
        "lng": 13.40,
        "cap_pfx": "67",
        "cities": ["L'Aquila", "Sulmona", "Avezzano"],
    },
    "AR": {
        "lat": 43.47,
        "lng": 11.88,
        "cap_pfx": "52",
        "cities": ["Arezzo", "Cortona", "Sansepolcro"],
    },
    "AT": {
        "lat": 44.90,
        "lng": 8.21,
        "cap_pfx": "14",
        "cities": ["Asti", "Canelli", "Nizza Monferrato"],
    },
    "AV": {
        "lat": 40.91,
        "lng": 14.79,
        "cap_pfx": "83",
        "cities": ["Avellino", "Ariano Irpino", "Solofra"],
    },
    "BA": {
        "lat": 41.13,
        "lng": 16.87,
        "cap_pfx": "70",
        "cities": ["Bari", "Altamura", "Gravina", "Molfetta"],
    },
    "BG": {
        "lat": 45.70,
        "lng": 9.67,
        "cap_pfx": "24",
        "cities": ["Bergamo", "Treviglio", "Caravaggio"],
    },
    ...
    "BN": {
        ...
        "lng": 14.78,
        "cap_pfx": "82",
        "cities": ["Benevento", "Sant'Agata de' Goti"],
    },
    "BO": {
        "lat": 44.49,
        "lng": 11.34,
        "cap_pfx": "40",
        "cities": ["Bologna", "Imola", "Casalecchio"],
    },
    ...
    "BS": {
        ...
        "lng": 10.22,
        "cap_pfx": "25",
        "cities": ["Brescia", "Desenzano", "Chiari"],
    },
    ...
    "BZ": {
        ...
        "lng": 11.35,
        "cap_pfx": "39",
        "cities": ["Bolzano", "Merano", "Bressanone"],
    },
    "CA": {
        "lat": 39.22,
        "lng": 9.11,
        "cap_pfx": "09",
        "cities": ["Cagliari", "Quartu", "Selargius"],
    },
    ...
    "CT": {
        ...
        "lng": 15.09,
        "cap_pfx": "95",
        "cities": ["Catania", "Acireale", "Paternò"],
    },
    ...
    "FG": {
        ...
        "lng": 15.55,
        "cap_pfx": "71",
        "cities": ["Foggia", "Manfredonia", "Cerignola"],
    },
    "FI": {
        "lat": 43.77,
        "lng": 11.25,
        "cap_pfx": "50",
        "cities": ["Firenze", "Empoli", "Sesto Fiorentino"],
    },
    ...
    "FR": {
        ...
        "lng": 13.35,
        "cap_pfx": "03",
        "cities": ["Frosinone", "Cassino", "Anagni"],
    },
    ...
    "IM": {
        ...
        "lng": 7.92,
        "cap_pfx": "18",
        "cities": ["Imperia", "Sanremo", "Ventimiglia"],
    },
    ...
    "LE": {
        ...
        "lng": 18.17,
        "cap_pfx": "73",
        "cities": ["Lecce", "Copertino", "Galatina", "Nardò"],
    },
    "LI": {
        "lat": 43.54,
        "lng": 10.31,
        "cap_pfx": "57",
        "cities": ["Livorno", "Piombino", "Cecina"],
    },
    ...
    "LT": {
        ...
        "lng": 12.90,
        "cap_pfx": "04",
        "cities": ["Latina", "Aprilia", "Terracina"],
    },
    "LU": {
        "lat": 43.84,
        "lng": 10.50,
        "cap_pfx": "55",
        "cities": ["Lucca", "Viareggio", "Capannori"],
    },
    "MB": {
        "lat": 45.58,
        "lng": 9.27,
        "cap_pfx": "20",
        "cities": ["Monza", "Sesto San Giovanni", "Cinisello"],
    },
    "MC": {
        "lat": 43.30,
        "lng": 13.45,
        "cap_pfx": "62",
        "cities": ["Macerata", "Civitanova", "Tolentino"],
    },
    "ME": {
        "lat": 38.19,
        "lng": 15.55,
        "cap_pfx": "98",
        "cities": ["Messina", "Barcellona", "Milazzo"],
    },
    "MI": {
        "lat": 45.47,
        "lng": 9.19,
        "cap_pfx": "20",
        "cities": ["Milano", "Sesto San Giovanni", "Cologno", "Legnano"],
    },
    ...
    "MO": {
        ...
        "lng": 10.93,
        "cap_pfx": "41",
        "cities": ["Modena", "Carpi", "Sassuolo", "Mirandola"],
    },
    ...
    "NA": {
        ...
        "lng": 14.27,
        "cap_pfx": "80",
        "cities": ["Napoli", "Pozzuoli", "Torre del Greco", "Ercolano", "Portici", "Castellammare"],
    },
    "NO": {
        "lat": 45.45,
        "lng": 8.62,
        "cap_pfx": "28",
        "cities": ["Novara", "Borgomanero", "Oleggio"],
    },
    ...
    "PA": {
        ...
        "lng": 13.35,
        "cap_pfx": "90",
        "cities": ["Palermo", "Bagheria", "Monreale", "Partinico"],
    },
    "PC": {
        "lat": 45.05,
        "lng": 9.70,
        "cap_pfx": "29",
        "cities": ["Piacenza", "Castel San Giovanni"],
    },
    "PD": {
        "lat": 45.41,
        "lng": 11.88,
        "cap_pfx": "35",
        "cities": ["Padova", "Abano Terme", "Vigonza"],
    },
    "PE": {
        "lat": 42.46,
        "lng": 14.21,
        "cap_pfx": "65",
        "cities": ["Pescara", "Montesilvano", "Francavilla"],
    },
    "PG": {
        "lat": 43.11,
        "lng": 12.39,
        "cap_pfx": "06",
        "cities": ["Perugia", "Foligno", "Spoleto"],
    },
    "PI": {
        "lat": 43.72,
        "lng": 10.40,
        "cap_pfx": "56",
        "cities": ["Pisa", "Pontedera", "San Miniato"],
    },
    ...
    "PR": {
        ...
        "lng": 10.33,
        "cap_pfx": "43",
        "cities": ["Parma", "Fidenza", "Salsomaggiore"],
    },
    "PT": {
        "lat": 43.93,
        "lng": 10.91,
        "cap_pfx": "51",
        "cities": ["Pistoia", "Montecatini", "Pescia"],
    },
    ...
    "PZ": {
        ...
        "lng": 15.80,
        "cap_pfx": "85",
        "cities": ["Potenza", "Melfi", "Lagonegro"],
    },
    ...
    "RC": {
        ...
        "lng": 15.65,
        "cap_pfx": "89",
        "cities": ["Reggio Calabria", "Palmi", "Gioia Tauro"],
    },
    "RE": {
        "lat": 44.70,
        "lng": 10.63,
        "cap_pfx": "42",
        "cities": ["Reggio Emilia", "Guastalla", "Scandiano"],
    },
    ...
    "RM": {
        ...
        "lng": 12.49,
        "cap_pfx": "00",
        "cities": ["Roma", "Tivoli", "Frascati", "Civitavecchia", "Anzio"],
    },
    "RN": {
        "lat": 44.06,
        "lng": 12.57,
        "cap_pfx": "47",
        "cities": ["Rimini", "Riccione", "Santarcangelo"],
    },
    ...
    "SA": {
        ...
        "lng": 14.76,
        "cap_pfx": "84",
        "cities": ["Salerno", "Battipaglia", "Eboli", "Cava de' Tirreni"],
    },
    "SI": {
        "lat": 43.32,
        "lng": 11.33,
        "cap_pfx": "53",
        "cities": ["Siena", "Poggibonsi", "Montepulciano"],
    },
    ...
    "SR": {
        ...
        "lng": 15.29,
        "cap_pfx": "96",
        "cities": ["Siracusa", "Augusta", "Lentini"],
    },
    "SS": {
        "lat": 40.73,
        "lng": 8.56,
        "cap_pfx": "07",
        "cities": ["Sassari", "Alghero", "Porto Torres"],
    },
    "SU": {
        "lat": 39.37,
        "lng": 8.85,
        "cap_pfx": "09",
        "cities": ["Carbonia", "Iglesias", "Villacidro"],
    },
    "SV": {
        "lat": 44.31,
        "lng": 8.48,
        "cap_pfx": "17",
        "cities": ["Savona", "Albenga", "Finale Ligure"],
    },
    "TA": {
        "lat": 40.47,
        "lng": 17.24,
        "cap_pfx": "74",
        "cities": ["Taranto", "Manduria", "Grottaglie"],
    },
    "TE": {
        "lat": 42.66,
        "lng": 13.70,
        "cap_pfx": "64",
        "cities": ["Teramo", "Giulianova", "Roseto"],
    },
    "TN": {
        "lat": 46.07,
        "lng": 11.12,
    ...
    "TO": {
        ...
        "lng": 7.69,
        "cap_pfx": "10",
        "cities": ["Torino", "Moncalieri", "Rivoli", "Collegno"],
    },
    "TP": {
        "lat": 38.02,
        "lng": 12.51,
        "cap_pfx": "91",
        "cities": ["Trapani", "Marsala", "Mazara del Vallo"],
    },
    ...
    "TV": {
        ...
        "lng": 12.24,
        "cap_pfx": "31",
        "cities": ["Treviso", "Montebelluna", "Conegliano"],
    },
    "UD": {
        "lat": 46.07,
        "lng": 13.23,
        "cap_pfx": "33",
        "cities": ["Udine", "Pordenone", "Gorizia"],
    },
    "VA": {
        "lat": 45.82,
        "lng": 8.83,
        "cap_pfx": "21",
        "cities": ["Varese", "Busto Arsizio", "Gallarate"],
    },
    ...
    "VE": {
        ...
        "lng": 12.35,
        "cap_pfx": "30",
        "cities": ["Venezia", "Mestre", "Chioggia"],
    },
    ...
    "VR": {
        ...
        "lng": 10.99,
        "cap_pfx": "37",
        "cities": ["Verona", "Legnago", "San Bonifacio"],
    },
...
_LEGAL_FORMS = [
    "SRL",
    "SRL",
    "SRL",  # weighted — most Italian SMEs are SRL
    "SPA",
    "SRLS",
    "SNC",
    "DI",
