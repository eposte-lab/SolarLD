...
DISPOSABLE_DOMAINS: frozenset[str] = frozenset({
    ...
    "tempmail.com", "tempmail.net", "tempmailaddress.com",
    "tempr.email", "trashmail.com", "trashmail.net",
    ...
    "moakt.com", "tempinbox.com", "spambox.us",
    "anonbox.net", "tempmailo.com", "emailondeck.com",
    "mohmal.com", "mailcatch.com", "mailnesia.com",
...
FREE_EMAIL_PROVIDERS: frozenset[str] = frozenset({
    ...
    "aol.com", "fastmail.com", "protonmail.com", "proton.me",
    "zoho.com", "gmx.com", "gmx.net",
    # Italy
    "yahoo.it", "hotmail.it", "outlook.it", "live.it",
    "libero.it", "virgilio.it", "tiscali.it", "alice.it",
    "tin.it", "iol.it", "email.it", "interfree.it",
    "tim.it", "inwind.it", "tiscalinet.it",
    "fastwebnet.it", "katamail.com",
})

ROLE_PREFIXES: frozenset[str] = frozenset({
    "info", "contact", "contatti", "contatto",
    "sales", "vendite", "commerciale",
    "support", "supporto", "assistenza",
    "admin", "amministrazione", "ufficio", "office",
    "noreply", "no-reply", "donotreply",
    "newsletter", "marketing",
    "privacy", "dpo", "compliance",
    "hr", "jobs", "lavoro", "careers",
    "accounting", "billing", "fatturazione",
    "help", "service",
})
